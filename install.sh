...
echo "• Or install locally from file: $REPO_DIR/releases/yt-dlp-extension-v1.0.5.zip"
echo ""
echo "Videos will automatically download to your configured yt-dlp path (or ~/Downloads)"
